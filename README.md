...
앱은 가로 화면 전용입니다. 터치 패드는 화면 양 끝에 분리되어 있으며 중앙 영역의 터치는 손 입력으로 처리되지 않습니다. 가장 빠른 완료 기록은 자동 저장되고 중앙의 **기록 리셋** 버튼으로 현재 기록과 함께 초기화할 수 있습니다.
...
1. 휴대폰을 가로로 들고 왼손과 오른손을 화면 양 끝의 각 패드에 동시에 올립니다.
...
완료 기록이 기존 최고기록보다 빠르면 최고기록이 자동으로 갱신되며 앱을 다시 실행해도 유지됩니다.
